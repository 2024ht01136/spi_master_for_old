...
set_property IOSTANDARD LVCMOS18 [get_ports {sendData[6]}]
set_property IOSTANDARD LVCMOS18 [get_ports {sendData[5]}]
set_property IOSTANDARD LVCMOS18 [get_ports {sendData[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {sendData[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {sendData[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {sendData[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {sendData[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports sendDataValid]
